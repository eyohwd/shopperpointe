...
const KEY =
  "pk_test_51O8OuiKg1MGPF9tMehdD8JMuwR2n0nEqjtkV29buAh2JfAxngcsyAFANr6DOLy3R8V3JsbWnLEtdPsGcqQF8zGwC001lOuVnvb";
  ...
  useEffect(() => {
    const makeRequest = async () => {
      try {
        ...
        //   `https://backendofshopperpointe.onrender.com/api/checkout/payment`,
        //   {
        //     headers: {
...
//   console.log(stripeToken, cart.total);
